...
rsync -av "$SCRIPT_DIR/conf/devel12/${projectName}.xml" "${devel}:tomcat/conf/Catalina/localhost/${projectName}.xml"
...
echo "$projectName.war deployed to $develServer:  http://$develServer:$tomcatHttpPort/$projectName"
